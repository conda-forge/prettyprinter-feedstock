...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/prettyprinter-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12844&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/prettyprinter-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `prettyprinter` can be installed with:

```
conda install prettyprinter
```

It is possible to list all of the versions of `prettyprinter` available on your platform with:
